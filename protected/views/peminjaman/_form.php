...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'status_persetujuan'); ?>
        <?php echo $form->dropDownList($model,'status_persetujuan',array("disetujui"=>"disetujui","belum disetujui"=>"belum disetujui"), array("class" => "input-block-level")); ?>
		<?php echo $form->error($model,'status_persetujuan'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'status_peminjaman'); ?>
        <?php echo $form->dropDownList($model,'status_peminjaman',array("sudah dikembalikan"=>"sudah dikembalikan","belum dikembalikan"=>"belum dikembalikan"), array("class" => "input-block-level")); ?>
		<?php echo $form->error($model,'status_peminjaman'); ?>
	</div>
