	...
	<div id="main">
		<div id="navigation" style="width:290px;">
			...
			<ul class="mainNav" data-open-subnavs="multi" style="width:280px;">
				...
				<?php
					if(Yii::app()->user->status === 'laboran'){
				?>
				...
				<li class='active'>
					...
					<ul class="subnav">
						...
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/pengumuman"><i class="icon-briefcase icon-white"></i><span> Data Pengumuman/Pesan</span></a>
						</li>
					</ul>
				</li>
				...
				<li class='active'>
					...
					<ul class="subnav">
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/peminjaman"><i class="icon-th-list icon-white"></i><span> Peminjaman Barang</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/peminjaman/kembali"><i class="icon-hdd icon-white"></i><span> Pengembalian Barang</span></a>
						</li>
					</ul>
				</li>
