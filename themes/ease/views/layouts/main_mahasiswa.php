				...
				<?php } ?>
					...
					<div class="dropdown-menu pull-right">
						<div class="right-details">
							...
							<ul>
								<li>
									<a href="<?php echo Yii::app()->baseUrl; ?>/profile_mahasiswa">Edit Profil</a>
								</li>
								<li>
									<a href="<?php echo Yii::app()->baseUrl; ?>/profile_mahasiswa">Change Password</a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div id="navigation" style="width:290px;">
			...
			<ul class="mainNav" data-open-subnavs="multi" style="width:280px;">
				...
				<li class='active'>
					...
					<ul class="subnav">
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/mahasiswa_barang"><i class="icon-th-list icon-white"></i><span> Data Barang</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/mahasiswa_peminjaman_barang"><i class="icon-th-list icon-white"></i><span> Data Peminjaman Barang</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/mahasiswa_modul_pembelajaran"><i class="icon-list icon-white"></i><span> Data Modul Pembelajaran</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/mahasiswa_pengumuman"><i class="icon-briefcase icon-white"></i><span> Data Pengumuman/Pesan</span></a>
						</li>
					</ul>
				</li>
	...
	<script type="text/javascript">
		var baseUrl = "<?php echo Yii::app()->baseUrl; ?>";
          ...
          function popup(url)
          {
           ...
           params += ', status=no';
           params += ', toolbar=no';
           newwin=window.open(url,'Pop Up', params);
